...
#define FLASH_OFFSET_INTRINSIC_KEY_2_KC (FLASH_OFFSET_INTRINSIC_KEY_1_KC + FLASH_SIZE_INTRINSIC_KEY_1_KC)
#define FLASH_SIZE_INTRINSIC_KEY_2_KC   ALIGN_UP(PUF_KEY_CODE_SIZE, FLASH_WRITE_SIZE)
